...
public class VowelAndConsonantSubstrings {
    public static void main(String[] args) {
        VowelAndConsonantSubstrings test = new VowelAndConsonantSubstrings();
        System.out.println(test.solve("aba"));
    ...
    public int solve(String A) {
        ...
        return (vowelCount%1000000007 * consonantCount%1000000007)%1000000007;
    }
